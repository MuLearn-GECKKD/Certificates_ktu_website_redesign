    ...
    .then((jsonData) => {
        ...
        if (matchingEntry) {
            ...
            const qr = new QRCode(qrContainer, {
                text: "https://https://github.com/MuLearn-GECKKD/Certificates_ktu_website_redesign.github.io/Certificates_ktu_website_redesign/KTUwebsiteRedesign/?id=" + matchingEntry.code,
                width: 384,
                height: 384,
                typeNumber: 8,
